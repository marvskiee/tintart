      ...
      <CustomerWrapper containerClass="p-6 lg:p-16 bg-slate-100">
        <div className='flex flex-col-reverse lg:flex-row gap-10 items-center my-4'>
          <div className='flex flex-col gap-4 w-full'>
            ...
            <h3 className=' text-xl'>Have you ever wanted to create and wear your own designs on your shirts? Be able to show your feelings through your art? Try our very own customization and print your own designs now!</h3>
            <div>
          ...
          <div className='flex w-full items-center justify-center'>
            <div className='lg:flex-shrink-0 aspect-square lg:max-h-[20rem]'>
              <img src="/images/hero.png" className='object-cover w-full h-full rounded-xl' />
            </div>
          </div>
        </div>
      </CustomerWrapper>
      ...
      <CustomerWrapper containerClass="bottom-0 text-white p-6 lg:p-16 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-red-500 to-red-800">
        <div className='flex flex-col gap-4 my-4'>
          ...
          <div className='mr-auto'>
            <Button color="failure" className='uppercase mx-auto border border-white' size="lg">CONTACT US</Button>
          </div>
        </div>
      </CustomerWrapper>
      <CustomerWrapper containerClass="p-6 lg:p-16">
        ...
        <div className='mx-auto'>
          <Button color="failure" className='uppercase mx-auto' size="lg">VIEW GALLERY</Button>
        </div>
      </CustomerWrapper>
    </CustomerLayout>
  )
